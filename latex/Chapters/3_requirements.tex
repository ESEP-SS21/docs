...
Übersichtlichkeit sinnvoll kategorisiert. Zum besseren Abgleich verweisen wir in den
Anforderungen jeweils auf die Sätze in dem Lastenheft, aus denen diese hervorgehen. 
...
\input{Chapters/UseCases/uc_01}

\input{Chapters/UseCases/uc_02}

\input{Chapters/UseCases/uc_03}

\input{Chapters/UseCases/uc_04}

\input{Chapters/UseCases/uc_05}

\input{Chapters/UseCases/uc_06}

\input{Chapters/UseCases/uc_07}

\input{Chapters/UseCases/uc_08}

\input{Chapters/UseCases/uc_09}

\input{Chapters/UseCases/uc_10}

\input{Chapters/UseCases/uc_11}

\input{Chapters/UseCases/uc_12}
...
was für die Bestimmung des Abstands bei der Werkstückübergabe zwischen zwei Anlagen wichtig sein könnte.

\subsubsection{Der Aufbau im Bereich des Aussortiermechnaismus}

Im Transportweg der Werkstücke befindet sich an der Stelle an der ein Werkstück vom Sortiermechanismus aussortiert werden muss eine Lichtschranke. 
