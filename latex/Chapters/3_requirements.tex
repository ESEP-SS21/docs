...
\subsection{Systemaufbau}\label{subsec:systemaufbau}
\begin{figure}[h]
    \centering
    \includegraphics[width = 0.9\textwidth]{anhang/festo.png}
    \caption{Schematik des Systemaufbaus}
    \label{fig:}
\end{figure}
\noindent Bei genauerer Betrachtung des Systemaufbaus fallen folgende Eigenschaften und
