...
Die Basis für die Implementation der STM-Tests ist in Kapitel~\ref{sec:basis-fuer-stms} beschrieben.

Im StmTestClient werden die über das Interface verschickten Events zwischengespeichert, sodass im Test
