...
\newglossaryentry{event}{
    ...
    name = {Event},
    plural={Events},
    description = {Auftretendes Ereignis, dass zwischen den Komponenten mittels
...
\newglossaryentry{ruhe-zst}{
    ...
    einen Fehler hervorgerufen wurde. Nach Starten befindet sich die \gls{anlage} in diesem Zustand.},
}
