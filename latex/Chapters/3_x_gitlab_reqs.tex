...
\begin{itemize}
    \item[REQ-7:] Zuführung von Werkstücken erfolgt durch Einlegen von Werkstücken am Anfang von \gls{anlage} 1 (14, 15)
    \begin{itemize}
        \item Ein Unterbrechen der \gls{lb_st} signalisiert dem System das Einlegen eines Werkstücks,
        sodass der Transport dessen beginnen kann.
    \end{itemize}
    \item[REQ-9:] Das System muss mit in beliebigem Abstand eingelegten Werkstücken umgehen können(16,17) %TODO Mindestabstand
    \begin{itemize}
    ...
    \end{itemize}
    \item[REQ-20:] Werkstücke dürfen nicht vom Förderband fallen (21)
    \item[REQ-24:] Beim Einlegen eines Werkstückes in die Anlage soll dem \gls{workpiece} eine eindeutige ID zugewiesen werden(28)
    \item[REQ-26:] Wenn sich auf einem Förderband kein Werkstück befindet, stoppt das Förderband.
