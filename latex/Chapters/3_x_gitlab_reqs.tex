...
\begin{itemize}
    ...
    \end{itemize}
    \reqitem{9} Das System muss mit in 20 cm Abstand eingelegten \glspl{workpiece} umgehen können (16, 17)
    \begin{itemize}
...
\paragraph{Bedienung durch \gls{taster}}
\begin{itemize}
    ...
    \end{itemize}
    \reqitem{17} Bei Betätigung von \gls{t_stop} im Betriebszustand wechselt die \gls{anlage} in den Ruhezustand (51, 52)
    \begin{itemize}
    ...
    \end{itemize}
    \reqitem{21} Bei Betätigung von \gls{t_reset} werden sämtliche Fehler quittiert (53) %TODO mit kunden kären
    \reqitem{28} Wenn die \gls{anlage} durch \gls{estop} stillgelegt ist, kann der Betrieb durch Drücken des
    \gls{t_reset} der \gls{anlage}, an dem auch der \gls{estop} gedrückt wurde, neu gestartet werden (56) %TODO 'fortsetzten' mit kunden kären
    \begin{itemize}
        \item Bedingung dafür: Keine \gls{estop} sind gedrückt und alle \glspl{workpiece} wurden aus den \glspl{anlage} entfernt
    \end{itemize}
    \reqitem{40} Im \gls{service-mode} führt die \gls{anlage} Kalibrierung und Selbsttests durch (50) %TODO item genauer spezifizieren %TODO Modi in glossar aufnehmen
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Falls eine Warnung vorliegt, leuchtet die grüne \gls{ampelled} nicht
    \end{itemize}
    \reqitem{11} Im \gls{service-mode} blinkt die grüne \gls{ampelled}  (60)
    \reqitem{13} Bei Warnungen blinken die gelben \glspl{ampelled} beider Anlagen (61)
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Ein \gls{workpiece} ist verklemmt, wenn es länger als 3 Sekunden braucht, um in der \gls{rampe} anzukommen
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{enumerate}
    \end{itemize}
    \reqitem{48} In den Zuständen 'bestehend\_unquittiert' und 'bestehend\_quittiert'
