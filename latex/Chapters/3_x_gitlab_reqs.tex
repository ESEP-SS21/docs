...
\begin{itemize}
    ...
    \begin{itemize}
        \item Bedingung für den Wechsel ist, dass weder Fehler noch Warnungen vorliegen dürfen. %TODO Warnung und Fehler in glossar aufnehmen
        Alles andere führt zu einer Fehlermeldung.
    \end{itemize}
    \item[REQ-21:] Bei Betätigung des \gls{t_reset} werden sämtliche Fehler quittiert (53) %TODO mit kunden kären
    ...
    \end{itemize}
    \item[REQ-40:] Im Service Modus führt die \gls{anlage} Kalibrierung und Selbsttests durch (50) %TODO genauer spezifizieren
...
\begin{itemize}
    ...
    \end{itemize}
    \item[REQ-27:] Die \gls{weiche} darf nicht länger als 'x' auf offen stehen (35, 36) %TODO 'offen' , zeit festlegen
    \begin{itemize}
...
\begin{itemize}
    \item[REQ-32:] Höhenmessung muss Kippung des Lasers mit einbeziehen (43, 44) %TODO clarify
\end{itemize}
