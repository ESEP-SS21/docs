...
\begin{itemize}
    ...
    \end{itemize}
    \item[REQ-41:] Bei Betätigung des \gls{estop} werden beide \glspl{anlage} angehalten (54, 55)
    \item[REQ-42:] Dem Benutzer werden Hinweise über die Benutzung der \gls{anlage} mithilfe der LEDs an der Tastatern gegeben
    \begin{itemize}
        \item Im Betriebszustand ist die LED am \gls{t_start} an, im Ruhezustand die LED am \gls{t_stop}.
        Bei einem gegangenen oder bestehenden Fehler ist die LED am \gls{t_reset} an.
    \end{itemize}
\end{itemize}
