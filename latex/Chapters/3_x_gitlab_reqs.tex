...
\begin{itemize}
    ...
    \begin{itemize}
        \item Anstehend unquittiert wird durch schnelles Blinken (1 Hz) signalisiert (74)\label{req-37a}
        \item Anstehend quittiert wird durch dauerhaftes Leuchten(75) signalisiert\label{req-37b}
        \item Gegangen unquittiert wird durch langsames Blinken (0,5 Hz) signalisiert (z.B.\ wenn ein\label{req-37c}
        \gls{workpiece} an einer \gls{weiche} zu langsam in die \gls{rampe} geschoben wurde) (76)
        \item Steht kein Fehler an, ist die Leuchte aus (73)\label{req-37d}
    \end{itemize}
