\begin{abntest}{Sortierung, Kapazität}{
    ...
    \begin{enumerate}
        ...
        \gls{lb_sw} erreicht, bleiben die \glspl{belt} beider \glspl{anlage} stehen (\refreq{6})
    \end{enumerate}
    ...
    \erwartung
    Am Ende von \gls{anlage} 2 kommt genau ein \Glspl{workpiece_metall} an (\refreq{47}, \refreq{18})
