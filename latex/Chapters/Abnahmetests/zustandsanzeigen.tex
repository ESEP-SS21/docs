\abntest{Bedienung durch Taster und Zustandsanzeigen}{
    \refreq{10},
    \refreq{11},
    \refreq{12},
    \refreq{15},
...
\begin{erwartung}
    ...
    beide grünen \glspl{ampelled}, alle anderen sind aus (\refreq{11}, \refreq{15})
    \item Nach Schritt~\ref{itm:to-idle} leuchten
    beide gelben \glspl{ampelled} dauerhaft, alle anderen sind aus (\refreq{45})
    \item Nach Schritt~\ref{itm:to-betriebsz} leuchten
    beide grünen \glspl{ampelled} dauerhaft, alle anderen sind aus (\refreq{10}, \refreq{12}, \refreq{19})
    \item Nach Schritt~\ref{itm:to-idle2} leuchten
    beide gelben \glspl{ampelled} dauerhaft, alle anderen sind aus (\refreq{45}, \refreq{17})
\end{erwartung}
