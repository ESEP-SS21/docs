\begin{usecase}{10}{Konfiguration}{hoch}
    \addTextCollum{Description}{
        ...
        Das Primary System wird durch Drücken des \gls{t_start}es der entsprechenden Anlage bestimmt
    }
    ...
    \addCollum{Mainflow}{
        ...
        \item[4)] Warten auf Drücken des \gls{t_start}es auf dem ControlPanel \textbullet
