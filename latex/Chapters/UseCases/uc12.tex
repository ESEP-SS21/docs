\begin{usecase}{12}{Handle Error}{hoch}
    ...
    Der Fehlerzustand der gesamten Anlage, somit auch die Anzeige der roten LED, wird durch den dem Fehler mit der höchsten Priorität in der Fehlerliste festgelegt. Die Fehlerzustände sind wie folgt priorisiert:
    }
    \addCollum{Fehlerpriorität}{
    \item[1)] astehend\_unqittiert. Wird durch ein dauerhaftes leuchten der roten LED signalisiert.
    \item[2)] astehend\_qittiert. Wird durch wird durch schnelles Blinken (1 Hz) der roten LED signalisiert.
    \item[3)] gegangen\_qittiert . Wird durch wird durch langsames Blinken (0,5 Hz) der roten LED signalisiert.
    }
    \addTextCollum{Description}{
    Ist der globale Fehlerzustand astehend\_unqittiert oder astehend\_qittiert,
