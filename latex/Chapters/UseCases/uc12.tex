\begin{usecase}{12}{Handle Error}{hoch}
    ...
    Ist der globale Fehlerzustand anstehend\_unqittiert oder anstehend\_qittiert,
    ...
    \item[1)] anstehend\_unqittiert. Wird durch ein dauerhaftes leuchten der roten LED signalisiert.
    \item[2)] anstehend\_qittiert. Wird durch wird durch schnelles Blinken (1 Hz) der roten LED signalisiert.
