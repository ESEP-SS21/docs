\begin{usecase}{08}{Switch To Idle}{mittel}
    ...
    \addCollum{Triggers}{
        \item Stopp-Taster am Control\_Panel betätigt
        \item Event Request\_Idle von FTS\_2
    }
    \addCollum{Mainflow}{
    ...
    \addCollum{Alternative FLow 1}{
        ...
        \begin{itemize}
            \item[1a1)] Request\_Idle wird an FTS\_2 gesendet
            \item[1a2)] Auf Acknowledge von FTS\_2 warten \textbullet
            \item[1a3)] mit step 1 of Mainflow weitermachen
        \end{itemize}
    }
