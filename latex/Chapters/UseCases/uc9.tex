\begin{usecase}{9}{Run Service}{hoch}
    ...
    \addCollum{Mainflow}{
        ...
        \item[1)] Stoplight grün blinken lassen
        ...
        \item[6)] Auf Zustandsänderungssignal des Sorting\_Mechanism warten \textbullet
        \item[7)] Sorting Mechanism deaktivieren
        \item[8)] Auf Zustandsänderungssignal des Sorting\_Mechanism warten \textbullet
        \item[9)] Stoplight Grün leuchten lassen
    }
