\begin{usecase}{02}{Determine Sorting Action}{hoch}
    ...
    \addCollum{Main flow}{
        ...
        \item[3)] Das \gls{workpiece} wird mit discard markiert \textbullet
    }
    \addCollum{Alternative flow 1}{
        \item at step 2 of main flow
        \item[2a)] Das \gls{workpiece} stimmt überein
        \begin{itemize}
            \item[2a1)] Das \gls{workpiece} wird mit do\_not\_discard markiert
    ...
    \addTextCollum{Postcondition}{
        Dem \gls{workpiece} ist entweder do\_not\_discard oder discard zugeordnet
    }
\end{usecase}
