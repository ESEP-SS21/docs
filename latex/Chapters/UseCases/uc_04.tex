\begin{usecase}{04}{\gls{workpiece} sortieren}{hoch}
    ...
    \addCollum{Main flow}{
        ...
        \item[3)] Das \gls{workpiece} wird aussortiert (UC05 \ref{uc:05}) \textbullet
    }
    \addCollum{Alternative flow 1}{
        \item at step 2 of main flow
        \item[2a)] Das \gls{workpiece_type} stimmt überein
        \begin{itemize}
            \item[2a1)] Das \gls{workpiece} wird durchgelassen (UC06 \ref{uc:06})
            \item[2a2)] Ende des Use-Case
        \end{itemize}
    }
    \addCollum{Alternative flow 2}{
        \item at step 3 of main flow
        \item[3a)] \gls{rampe} ist voll und \gls{anlage} in \gls{primary}
        \begin{itemize}
            \item[3a1)] das \gls{workpiece} wird durchgelassen (UC06 \ref{uc:06})
        \end{itemize}
        \item[3b)] \gls{rampe} ist voll und \gls{anlage} in \gls{secondary}
        \begin{itemize}
