\begin{usecase}{08}{Answer Transfer Request}{mittel}
    ...
    \addTextCollum{Description}{
        ...
        Die Anfrage geht von einer Anlage in Primary Mode aus und wird von dieser Anlage, die sich in Secondary Mode befindet beantwortet.
    }
