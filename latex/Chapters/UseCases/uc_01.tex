\begin{usecase}{01}{\gls{workpiece}-Annahme}{hoch}
    ...
    \addCollum{Precondition}{
        ...
        \item Es befindet sich kein \gls{workpiece} im Bereich von \gls{lb-st}
    }
    \addCollum{Trigger}{
        \item \gls{lb-st}
    }
    \addCollum{Main flow}{
        ...
        \item[2)] \gls{band} ist nicht in Bewegung \textbullet
        \item[3)] \gls{band} wird in Bewegung gesetzt
        \item[4)] Warte bis \gls{lb-st} nicht mehr unterbrochen \textbullet
    }
    \addCollum{Alternative Flow 1}{
        \item at step 2) of Mainflow
        \item[2a)] \gls{band} ist bereits in Bewegung und muss nicht gestartet werden
    }
    \addCollum{Alternative Flow 2}{
        \item at step 3) of Mainflow
        \item[3a)] \gls{workpiece} wartet am Ende der Anlage auf Übergabe
    \begin{itemize}
        \item 3a1) \gls{band} wird nicht gestartet
    \end{itemize}
    }
    \addCollum{Postcondition}{
        \item \gls{workpiece} ist eindeutig erfasst
        \item \gls{lb-st} ist nicht mehr unterbrochen
    }
\end{usecase}
